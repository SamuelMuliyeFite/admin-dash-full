...
const SignUp = () => {
  ...
  const register = (e) => {
    ...
    axiosinstance
      ...
      .then((res) => {
        if (res.status == '200') {
          setMessage('admin created succesfully')
          setTimeout(()=>{
            setMessage('')
          },2000)
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
           ...
           {message && (
           <div className="bg-[#219653] border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
           <div className="flex">
